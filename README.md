...
Download the [executable file](https://github.com/metalevel-tech/windows-always-on-top/releases/tag/v.0.1.0-ctrl-alt-t) and start it. Now you will be able to use `Ctrl`+`Alt`+`T` to keep (or release) a window on top. Tested with Windows 10.
